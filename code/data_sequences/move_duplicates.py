...
# Given the dataset (in ./train), it finds the groups of pictures indicated in the .json file and moves them to a
# different folder.
#
# Script by gabrieldemarmiesse from https://www.kaggle.com/c/the-nature-conservancy-fisheries-monitoring/discussion/28225
